package ua.vozniuk.demo.googleapi;
...
public class GmailMessages implements GoogleAPI{
    private static final String APPLICATION_NAME = "Gmail API Java Quickstart";
    private static String lastMessage;
    private static final List<String> GMAIL_SCOPE = Collections.singletonList(GmailScopes.GMAIL_READONLY);
    ...
    public static class ReadMessages {
        ...
        public static Credential getCredentials(NetHttpTransport HTTP_TRANSPORT) throws IOException {
            ...
            GoogleAuthorizationCodeFlow flow = new GoogleAuthorizationCodeFlow.Builder(
                    HTTP_TRANSPORT, JSON_FACTORY, clientSecrets, GMAIL_SCOPE)
    ...
    static class SendMessage {
         ...
         *
         * @param fromEmailAddress - Email address to appear in the foгm: header
